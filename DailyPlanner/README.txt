...
HUD overlay and Generic Mod Config Menu support added!
...
3) Install Generic Mod Config Menu to change settings in-game (recommended).
4) Go into Stardew Valley/Mods/DailyPlanner/Plans and edit Checklist.txt, adding tasks you want to complete (optional).
...
Known issues: 
1) The text boxes on the "Add Task" tab are kind of glitchy, sometimes it's hard to de-select them. Pressing Escape and Enter de-selects them for you.
2) Really long task names can trail off the right side of the menu. A fix for that might come eventually.
3) Text in the Generic Mod Config Menu is not translated yet, this will come next patch.
