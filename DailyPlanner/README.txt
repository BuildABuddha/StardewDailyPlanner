...
This is the 0.1 pre-release version of this mod. The GUI is pretty much ripped out of the Cheat Menu Mod, and a lot of it is a work in progress. 
...
Upcoming features:
1) Ability to add (and possibly remove) objects to your plan while in-game, rather than having to rely on a spreadsheet program.
2) A "week" tab that shows you a view of every task for the next seven days so you can plan ahead.
3) A "month" tab that shows you a similar view to the "week" tab, but for the whole season.
4) More languages, maybe?
